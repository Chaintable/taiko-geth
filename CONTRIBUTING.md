...
This repository is a **fork**: upstream [taikoxyz/taiko-geth](https://github.com/taikoxyz/taiko-geth)
...
a general-purpose fork of taikoxyz/taiko-geth.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `taiko-alethia-client-v2.3.1-ct.2`); a GitHub Release publishes the versioned images
